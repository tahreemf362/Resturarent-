...
export default function Footer() {
  return (
  <footer className="mt-12 text-black" style={{ backgroundColor: '#FFD600', fontFamily: 'Poppins, sans-serif', color: 'black' }}>
      <div className="container mx-auto px-4 py-14 flex flex-col md:flex-row justify-between items-center gap-12 md:gap-20">
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          <div className="font-extrabold text-3xl flex items-center gap-3 tracking-wider mb-2">
            ...
            <span className="text-black drop-shadow-lg" style={{ letterSpacing: '2px', fontFamily: 'Poppins, sans-serif', color: 'black' }}>RestroHub</span>
          </div>
          <p className="mt-2 max-w-xs text-base font-medium" style={{ color: 'black', fontFamily: 'Poppins, sans-serif' }}>Handmade dishes, seasonal ingredients, and warm hospitality. Experience the taste of tradition and innovation in every bite.</p>
        ...
        <div className="flex flex-col gap-7 md:gap-10 text-center md:text-left">
          <div>
            <div className="font-extrabold text-lg mb-1 drop-shadow" style={{ fontFamily: 'Poppins, sans-serif', color: 'black' }}>Philosophy</div>
            <div style={{ color: 'black', fontFamily: 'Poppins, sans-serif' }}>Quality ingredients, sustainable sourcing and bold flavors.</div>
          </div>
          <div>
            <div className="font-extrabold text-lg mb-1 drop-shadow" style={{ fontFamily: 'Poppins, sans-serif', color: 'black' }}>Private Events</div>
            <div style={{ color: 'black', fontFamily: 'Poppins, sans-serif' }}>Book our private dining room for celebrations and corporate events.</div>
          </div>
          <div>
            <div className="font-extrabold text-lg mb-1 drop-shadow" style={{ fontFamily: 'Poppins, sans-serif', color: 'black' }}>Gift Cards</div>
            <div style={{ color: 'black', fontFamily: 'Poppins, sans-serif' }}>Give the gift of tasty memories — available online and in-store.</div>
          </div>
        </div>
      </div>
  <div className="border-t border-black/30 py-4 text-center text-sm tracking-wide bg-opacity-80" style={{ color: 'black', fontFamily: 'Poppins, sans-serif' }}>© {new Date().getFullYear()} RestroHub — All rights reserved</div>
    </footer>
  );
}